...
8. Seed one or two lessons end-to-end before mass ingestion. Done; fifteen seed
   lessons now build end-to-end for Prealgebra 2.3, 2.4, 2.5, 2.6, 3.2, 3.3,
   3.4, 3.5, 3.6, 4.2, 4.3, 4.4, 4.5, 4.6, and 4.7.
...
Current next seed candidate after the latest local work: Prealgebra 4.8
`Solve Equations with Fractions`, displayed as product lesson 3.7 under
`Kesirler`.

Latest completed seed lesson: Prealgebra 4.7 `Add and Subtract Mixed Numbers`,
displayed as product lesson 3.6 `Karma Kesirlerde Toplama ve Çıkarma`. It
includes 5 Turkish editorial sections, 28 Sıra Sizde solutions, 31 source
exercises with explanatory reveal solutions, and 18 extracted source assets.
