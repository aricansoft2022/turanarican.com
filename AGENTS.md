...
8. Seed one or two lessons end-to-end before mass ingestion. Done; sixteen seed
   lessons now build end-to-end for Prealgebra 2.3, 2.4, 2.5, 2.6, 3.2, 3.3,
   3.4, 3.5, 3.6, 4.2, 4.3, 4.4, 4.5, 4.6, 4.7, and 4.8.
...
Current next seed candidate after the latest local work: Prealgebra 5.2
`Decimals`, displayed as product lesson 4.1 under `Ondalık Sayılar`.

Latest completed seed lesson: Prealgebra 4.8 `Solve Equations with Fractions`,
displayed as product lesson 3.7 `Kesirli Denklemleri Çözme`. It includes 6
Turkish editorial sections, 28 Sıra Sizde solutions, 38 source exercises with
explanatory reveal solutions, and 21 extracted source assets.
