...
8. Seed one or two lessons end-to-end before mass ingestion. Done; twenty-seven seed
...
Current next seed candidate after the latest local work: Prealgebra 6.6
`Solve Proportions and their Applications`, displayed as product lesson 5.5 under the
`Yüzdeler` product chapter.

Latest completed seed lesson: Prealgebra 6.5
`Solve Simple Interest Applications`, displayed as product lesson 5.4
`Basit Faiz`. It includes 2 Turkish editorial sections, 14 Sıra Sizde
solutions, 21 source exercises with explanatory reveal solutions, and 13
