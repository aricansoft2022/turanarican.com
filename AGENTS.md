...
8. Seed one or two lessons end-to-end before mass ingestion. Done; eight seed
...
Current next seed candidate after the latest local work: Prealgebra 3.6
`Solve Equations Using Integers; The Division Property of Equality`, displayed
as product lesson 3.5 under `Tam Sayılar`.
